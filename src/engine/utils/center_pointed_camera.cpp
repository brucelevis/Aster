#include "center_pointed_camera.h"
...
namespace Utils
{
  CenterPointedCamera::CenterPointedCamera(float r, float xAngle, float yAngle, const glm::vec2& wndSize)
  ...
  void CenterPointedCamera::Rotate(double dx, double dy)
  {
    m_xAngle -= dx * 0.3f;
    m_yAngle -= dy * 0.3f;
